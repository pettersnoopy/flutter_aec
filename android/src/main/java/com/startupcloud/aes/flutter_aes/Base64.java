...
public class Base64 {
    ...
    private static final char FIX_CHAR = '=';
    private static final char FIX_CHAR_1 = '+';
    private static final char FIX_CHAR_2 = '/';
    ...
    public static char[] encode(byte[] in, int iOff, int iLen) {
        ...
        while (ip < iEnd) {
            ...
            out[op++] = map1[o0];
            out[op++] = map1[o1];
            out[op] = op < oDataLen ? map1[o2] : FIX_CHAR;
            op++;
            out[op] = op < oDataLen ? map1[o3] : FIX_CHAR;
            op++;
        }
        return out;
    }
    ...
    public static byte[] decode(char[] in, int iOff, int iLen) {
        ...
        while (iLen > 0 && in[iOff + iLen - 1] == FIX_CHAR){
            iLen--;
        }
        int oLen = (iLen * 3) / 4;
